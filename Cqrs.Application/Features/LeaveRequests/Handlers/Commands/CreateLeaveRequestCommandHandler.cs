...
using Cqrs.Application.Contracts.Infrastructure;
...
namespace Cqrs.Application.Features.LeaveRequests.Handlers.Commands
{
    public class CreateLeaveRequestCommandHandler : IRequestHandler<CreateLeaveRequestCommand, int>
    {
        ...
        public CreateLeaveRequestCommandHandler(ILeaveTypeRepository leave,ILeaveRequestRepository leaveRequestRepository,
        ...
        public async Task<int> Handle(CreateLeaveRequestCommand request, CancellationToken cancellationToken)
        {
            ...
            var validator = new CreateLeaveRequestDtoValidator(_leave);
            ...
            else
            {
                ...
                try
                {
                    ...
                    var email = new Email
                    {
                        To = "alireza.mahmoudi.71@gmail.com",
